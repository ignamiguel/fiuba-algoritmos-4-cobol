       ...
       01 LINEA-TOTAL-POR-FECHA.
           ...
           03 DATO-TOTAL-POR-FECHA-HORAS PIC ZZ9.99.
           03 FILLER PIC X(3) VALUE SPACES.
           03 DATO-TOTAL-POR-FECHA-IMPORTE PIC ZZZZZZ9.99.
           03 FILLER PIC X(3) VALUE SPACES.
       ...
       01 LINEA-TOTAL-POR-EMPRESA.
           ...
           03 DATO-TOTAL-POR-EMP-HORAS PIC ZZZ9.99.
           03 FILLER PIC X(2) VALUE SPACES.
           03 DATO-TOTAL-POR-EMP-IMPORTE PIC ZZZZZZZ9.99.
           03 FILLER PIC X(3) VALUE SPACES.
       ...
       01 LINEA-TOTAL-GRAL.
           ...
           03 DATO-TOTAL-GRAL-IMPORTE PIC ZZZZZZZ9.99.
           03 FILLER PIC X(3) VALUE SPACES.
      ...
      ******************************************************************
       BUSQUEDA-EN-TARIFAS.
         CALL "BUSQUEDATARIFA"
         USING CATEGORIA-SRT,REG-RELEASE-TIM-FECHA
       ,REG-RELEASE-TIM-HORAS,REG-RELEASE-IMPORTE.
         DISPLAY 'IMPORTE DE TAR: ', REG-RELEASE-IMPORTE.
